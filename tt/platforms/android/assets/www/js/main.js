  ...
  require(['preloader', 'router'], function(PreLoader, AppRouter) {
    ...
    function populateDB(tx) {
          ...
          tx.executeSql('INSERT INTO FILM (title , txt, genre, year, img) VALUES ("The Lord of the Rings: The Fellowship of the Ring", "A meek hobbit of the Shire and eight companions set out on a journey to Mount Doom to destroy the One Ring and the dark lord Sauron.", "fantasy", "2001", "http://ia.media-imdb.com/images/M/MV5BNTEyMjAwMDU1OV5BMl5BanBnXkFtZTcwNDQyNTkxMw@@._V1_SY317_CR1,0,214,317_AL_.jpg")');
           ...
           tx.executeSql('INSERT INTO FILM (title , txt, genre, year, img) VALUES ("Saw", "Two men awaken in the secure lair of a killer who forces them to play a deadly game that will determine life or death.", "horror", "2004", "http://ia.media-imdb.com/images/M/MV5BMjAyNTcxNzYwMV5BMl5BanBnXkFtZTgwMzQzNzM5MjE@._V1_SX214_AL_.jpg")');
            ...
            tx.executeSql('INSERT INTO FILM (title , txt, genre, year, img) VALUES ("The Devil Wears Prada", "A smart but sensible new graduate lands a job as an assistant to Miranda Priestly, the demanding editor-in-chief of a high fashion magazine.", "comedy", "2006", "http://ia.media-imdb.com/images/M/MV5BMTMyNjk4Njc3NV5BMl5BanBnXkFtZTcwNDkyMTEzMw@@._V1_SX214_AL_.jpg")');
                 ...
                 tx.executeSql('INSERT INTO FILM (title , txt, genre, year, img) VALUES ("Le fabuleux destin d\'Amelie Poulain", "Amelie is an innocent and naive girl in Paris with her own sense of justice. She decides to help those around her and, along the way, discovers love.", "romantic", "2001", "http://ia.media-imdb.com/images/M/MV5BMTYzNjkxMTczOF5BMl5BanBnXkFtZTgwODg5NDc2MjE@._V1_SY317_CR0,0,214,317_AL_.jpg")');
         ...
         tx.executeSql('CREATE TABLE IF NOT EXISTS BAND (title unique, txt, genre, year, img)');
                 ...
                 tx.executeSql('INSERT INTO BAND (title , txt, genre, year, img) VALUES ("System of a Down", "Chart-topping but challenging alt-metal band that incorporates programmed beats and subtle Eastern European influences.", "metal", "1995", "http://cps-static.rovicorp.com/3/JPG_400/MI0003/534/MI0003534134.jpg")');
                 ...
                 tx.executeSql('INSERT INTO BAND (title , txt, genre, year, img) VALUES ("Frederic Chopin", "One of the most significant and individual composers of the Romantic age. ", "classical", "1810", "http://cps-static.rovicorp.com/3/JPG_400/MI0002/864/MI0002864430.jpg")');
                 ...
                 tx.executeSql('INSERT INTO BAND (title , txt, genre, year, img) VALUES ("Pink Floyd", "One of the most predominant and celebrated rock bands of all time, prog- and space-rock legends, known for superlative musicianship.", "rock", "1965", "http://cps-static.rovicorp.com/3/JPG_400/MI0001/428/MI0001428642.jpg")');
                 tx.executeSql('INSERT INTO BAND (title , txt, genre, year, img) VALUES ("The Beatles", "The most popular and influential rock act of all time, a band that blazed several new trails for popular music.", "rock", "1957", "http://cps-static.rovicorp.com/3/JPG_400/MI0003/361/MI0003361571.jpg")');
                 tx.executeSql('INSERT INTO BAND (title , txt, genre, year, img) VALUES ("Katy Perry", "Pop superstar who succeeded by combining cheeky, club-ready dance with the commercial pop/rock of Avril Lavigne and Alanis Morrissette.", "pop", "2000", "http://cps-static.rovicorp.com/3/JPG_400/MI0003/611/MI0003611183.jpg")');
