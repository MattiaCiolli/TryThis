    ...
    function populateDB(tx) {
        /*---------- FILM TABLE ---------- */
         ...
         tx.executeSql('CREATE TABLE IF NOT EXISTS BOOK (title unique, txt, genre, year, img)');
                 tx.executeSql('INSERT INTO BOOK (title , txt, genre, year, img) VALUES ("To Kill a Mockingbird", "The unforgettable novel of a childhood in a sleepy Southern town and the crisis of conscience that rocked it.", "Novel", "1960", "https://d.gr-assets.com/books/1361975680l/2657.jpg")');
